...
- Retrospectives disposition: swap in the three redacted files, move five to the archive, rewrite local history (after the harness assessment finishes reading).
...
- Retrospectives disposition in progress: redacted copies of the three narrative files are verified in the scratchpad; the five others move to the archive and local history is rewritten once the harness assessment finishes reading them.
