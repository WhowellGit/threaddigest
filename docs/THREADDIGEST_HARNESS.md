...
**Guards ledger rows** (`docs/runbook/GUARDS.md`): Active 39, External controls 5, Retired 0, Loosenings 3
...
**Tools** (`tools/*.py`): `check_stamp.py`, `code_health.py`, `doc_policy.py`, `harness_page.py`, `hash_remap.py`, `hooks_status.py`, `make_demo_fixture.py`, `memory_snapshot.py`, `private_terms.py`, `ratchet.py`, `render_plan.py`, `review_packet.py`, `vulture_whitelist.py`
