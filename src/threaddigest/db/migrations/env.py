...
config, or the ``THREADDIGEST_DB_URL`` environment variable.
"""
...
def _resolve_url() -> str:
    ...
    url = (
        ...
        or os.environ.get("THREADDIGEST_DB_URL")
    )
    if not url:
        msg = (
            "No database URL: pass -x db_url=sqlite:///path.db, set THREADDIGEST_DB_URL, "
