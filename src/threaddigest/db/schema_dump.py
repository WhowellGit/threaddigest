...
Regenerate with ``uv run python -m threaddigest.db.schema_dump``.
"""
...
def dump_schema(engine: Engine) -> str:
    ...
    parts: list[str] = [
        ...
        "-- generated by `python -m threaddigest.db.schema_dump`; do not edit by hand",
        "",
    ]
...
def write_schema_sql(path: Path = SCHEMA_SQL) -> str:
    ...
    with tempfile.TemporaryDirectory(prefix="threaddigest-schema-") as tmp:
